...
<center>图 1：全生命周期数据保护，以 OpenClaw 为例</center>
...
<center>图 2：从构建产物到受证明的运行时</center>
...
**适配器**
 ...
 - **[Openclaw](./adapters/OpenClaw/scripts)** : 提供自主构建openclaw gateway相关服务。这使得openclaw运行在一个安全/隔离的环境，以避免对宿主机产生任何不必要的影响。
