...
```
- From the server terminal you can see the value of MRSigner, then replace the original value of MRSigner in the clf_server.conf with the output value on the screen.
