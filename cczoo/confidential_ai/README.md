...
- Run openwebui
  ...
  <img src="./images/openwebui-backend.png" title="" alt="backend service" style="zoom:50%;">
  ...
  <img title="" src="./images/openwebui-fronted.png" alt="backend service" style="zoom:67%;">
  3.open browser and goto address: https://{ip_address}:18080/(The ip address is your server ip)
  4.Example:
    get quote data and parse
    <img src="./images/parse.png" title="" alt="backend service" style="zoom:50%;">
