...
cdef extern from "grpcpp/security/sgx/sgx_ra_tls.h" namespace "grpc::sgx":
  cdef void grpc_sgx_ra_tls_parse_sgx_config "grpc::sgx::ra_tls_parse_sgx_config"(sgx_mrs_context);

cdef extern from "grpcpp/security/sgx/sgx_ra_tls.h" namespace "grpc::sgx":
  cdef void grpc_sgx_ra_tls_parse_sgx_config_json "grpc::sgx::ra_tls_parse_sgx_config"(const char *);
