...
Define the reservation-backed commit-intent contract that TruCon uses to allocate predecessor state before replayable records are signed and committed.
