...
The baseline contract SHALL define one owner public key for the chain at Event Log 0. That key SHALL represent the single long-term chain owner for all later replayable writes until a future change explicitly introduces rotation or delegation.
