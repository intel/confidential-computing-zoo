...
Define the canonical runtime-engine abstraction for Docktap so engine-specific request parsing remains isolated while auditable lifecycle, commit, and verification semantics stay stable across supported runtimes.
