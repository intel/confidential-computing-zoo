...
Define how the chain verification system handles delegation-authorized events, including delegation chain annotation, signer identity resolution via delegation, and scope/TTL validation.
