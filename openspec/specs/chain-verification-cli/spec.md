...
Define the operator-facing verification requirements for the chain verification CLI, including replay, evidence handling, fallback behavior, and result reporting.
## Requirements
