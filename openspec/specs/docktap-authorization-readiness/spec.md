...
Define the high-level Docktap authorization readiness capability that callers can use to confirm or establish authorization for Docker-backed work without treating raw delegation creation as the primary integration surface.
